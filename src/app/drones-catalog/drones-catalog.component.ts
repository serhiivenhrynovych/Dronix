...
export class DronesCatalogComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.detailsArr6 = [
      ...
      {name: 'Мотори оригінальні', price: 3500, minImg: 'assets/photo/detail12.jpg', fullImg: 'assets/photo/img5.JPG'},
    ...
    this.dronesArr = [
      ...
      {name: 'DJI Mavic 2 PRO/ZOOM', price: 34000, minImg: 'assets/photo/dronMavic2Pro.jpg', fullImg: 'assets/photo/img5.JPG', charge: '20', controlLength: '3',
        speed: '50', sensorLength: '30', stabilizer: '2', pixels: '12', details: this.detailsArr2},
      {name: 'DJI Mavic Air', price: 24300, minImg: 'assets/photo/dronMavicAir.jpg', fullImg: 'assets/photo/img5.JPG', charge: '21', controlLength: '2',
        speed: '50', sensorLength: '30', stabilizer: '2', pixels: '12', details: this.detailsArr3},
